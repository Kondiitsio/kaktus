...
<section class="container max-w-7xl py-20 mx-auto px-6 lg:px-8 bg-[#FFF] rounded-md mt-16">
...
<div class="mt-10 lg:mt-0">
        ...
        <h2 class="text-3xl font-bold tracking-tight text-gray-900">{{ $store->title }}</h2>
        <p class="my-6 leading-7 text-gray-600">{{ $store->subtitle }}</p>

    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        @foreach ($stores as $store)
        <div class="rounded-md bg-[#FFF5F5] p-10">
